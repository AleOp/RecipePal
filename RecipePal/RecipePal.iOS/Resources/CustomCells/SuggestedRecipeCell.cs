...
{
    public partial class SuggestedRecipeCell : MvxTableViewCell
    {
        public SuggestedRecipeCell(IntPtr handle) : base(handle)
        {
            this.DelayBind(() =>
            {
                var bindingSet = this.CreateBindingSet<SuggestedRecipeCell, Recipe>();
