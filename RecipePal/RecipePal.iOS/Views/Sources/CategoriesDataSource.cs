...
{
    public class CategoriesDataSource : MvxTableViewSource
    {
        private readonly CategoriesViewModel _viewModel;
        private int _animatedRow = -1;
        private readonly NSString _cellId;
        public CategoriesDataSource(UITableView tableView, NSString cellId, CategoriesViewModel viewModel) : base(tableView)
        {
            _cellId = cellId;
        ...
        public override void RowSelected(UITableView tableView, NSIndexPath indexPath)
        {
            ...
            _viewModel.ShowCategorizedRecipesCommand.Execute(((ICollection<Category>)ItemsSource).ElementAt(indexPath.Row));
        }
    }
}