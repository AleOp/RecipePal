...
{
    public class FavoritesDataSource : MvxTableViewSource
    {
        ...
        public FavoritesDataSource(UITableView tableView, NSString cellId,FavoritesViewModel viewModel) : base(tableView)
        {
            _cellId = cellId;
